...
This demo shows how to program a MSPM0 MCU using a LP-MSPM0L1117 as host by BSL I2C interface.
...
| --- | --- | --- | --- | --- |
| PA0 | GPIOA | PA0 | J1_10 | <ul><li>PA0 is 5V tolerant open-drain so it requires pull-up<br><ul><li>`J1 1:2` Use 3.3V pull-up<br><li>`J1 2:3` Use 5V pull-up</ul><br><li>PA0 can be connected to LED1<br></ul> |
