...
OBJECTS = empty_mspm0g3519.obj iar_startup_mspm0g3519_iar.obj $(patsubst %.c,%.obj,$(notdir $(SYSCFG_C_FILES)))
...
iar_startup_mspm0g3519_iar.obj: ../iar/startup_mspm0g3519_iar.c $(SYSCFG_H_FILES)
	@ echo Building $@
	@ $(CC) $(CFLAGS) $< -o $@
