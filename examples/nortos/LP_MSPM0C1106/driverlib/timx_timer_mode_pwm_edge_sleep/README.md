...
TimerG14 will output a pair of 62.5Hz edge aligned PWM signals on PA0 and PA6.
PA0 is configured at a 75% duty cycle.
PA6 is configured at a 50% duty cycle.
Monitor the PWM signals on PA0 and PA6.
