...
## Example Usage
Compile, load and run the example. Monitor the PWM signals on PA0, PA22, PA7,
and PA25.
The pair of signals on PA0 and PA22 are complementary signals with deadband
insertion.
The second pair of signals on PA7 and PA25 are also complementary signals with
deadband insertion.
