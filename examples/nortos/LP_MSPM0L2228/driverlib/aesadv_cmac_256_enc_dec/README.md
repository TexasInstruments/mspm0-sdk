...
## Example Usage
As we are loading non-main with csc enabled configuration give BOR(boot reset) after loading application file.
Then Compile, load and run the example.

The application will hit a SW breakpoint to allow the user to inspect the value of gCorrectResults and gSuccessfulOperation to see if the AES operation completed successfully. gAesTagOut will have the value generated tag.
