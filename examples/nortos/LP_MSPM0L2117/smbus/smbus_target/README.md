...
| --- | --- | --- | --- | --- |
| PB0 | GPIOB | PB0 | J5 | <ul><li>PB0 can be connected to LED2 Blue<br><ul><li>`J5 ON` Connect to LED2 Blue<br><li>`J1 OFF` Disconnect from LED2 Blue</ul></ul> |
...
| PA10 | UC7 | SDA | J3_30 | <ul><li>PA10 can be connected to an on-board pull-up resistor<br><ul><li>`R60` is not soldered by default<br><li>Solder `R60` to use on-board pull-up</ul></ul> |
| PA11 | UC7 | SCL | J3_31 | <ul><li>PA11 can be connected to an on-board pull-up resistor<br><ul><li>`R59` is not soldered by default<br><li>Solder `R59` to use on-board pull-up</ul></ul> |
| PA22 | ADC0 | A7 | J1_6 | <ul><li>PA27 can be connected to photodiode D1<br><ul><li>`J17 OFF` Disconnect from photodiode D1</ul></ul> |
...
MSPM0 LaunchPad, please visit the [LP-MSPM0L2117 User's Guide](https://www.ti.com/tool/LP-MSPM0L2117).
