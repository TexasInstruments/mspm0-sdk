...
| --- | --- | --- |
| SYSCTL |  |  |
| UC8 | PA20 | SPI SCLK (Clock) |
| UC8 | PA17 | SPI PICO (Peripheral In, Controller Out) |
| UC8 | PA19 | SPI POCI (Peripheral Out, Controller In) |
| UC8 | PB20 | SPI CS0 (Chip Select 0) |
...
MSPM0 LaunchPad, please visit the [LP-MSPM0L2117 User's Guide](https://www.ti.com/tool/LP-MSPM0L2117#tech-docs).
