...
| --- | --- | --- | --- | --- |
| PA0 | GPIOA | PA0 | J3_10  | <ul><li>PA0 is 5V tolerant open-drain so it requires pull-up<ul><li>`J12 2:3` Use 3.3V pull-up <li>`J12 1:2` Use 5V pull-up</ul></ul> |
| PA1 | TIMG14 | PA1 | J3_9 | <ul><li>PA1 is 5V tolerant open-drain so it requires pull-up<ul><li>`J13 2:3` Use 3.3V pull-up <li>`J13 1:2` Use 5V pull-up</ul></ul> |
