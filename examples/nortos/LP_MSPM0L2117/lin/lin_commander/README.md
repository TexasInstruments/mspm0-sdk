...
| --- | --- | --- | --- | --- |
| UC4 | RX Pin | PA11 | J3_31 | |
| UC4 | TX Pin | PA10 | J3_30 | |
| EVENT | | | | |
| DMA | | | | |
| CRCP | | | | |
| TIMG0 | | | | |
...
| GPIOA | Standard Input | PA18 | S2 | |
| GPIOA | Standard Output | PA23 | LED2 Blue | |
| GPIOB | Standard Output | PB0 | LED2 Red | |
| GPIOB | Standard Input with pull-up | PB8 | S3 | |
| GPIOB | Standard Output  | PB15 | J2_18 | |
...
Note: the BOOSTXL-CANFD-LIN BoosterPack is not directly compatible with the LP_MSPM0L2117 LaunchPad since the pins on the UART connector don't support LIN. For this reason, the BoosterPack shouldn't be stacked on top of the LaunchPad.
...
When S3 button is pressed, the following LIN 2.0 packet will be transmitted:
  - PID: 0x39
