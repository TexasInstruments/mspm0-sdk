...
This example can be used with the spi_peripheral_repeated_multibyte_fifo_dma_interrupts example running on another device with the breakpoint disabled.
