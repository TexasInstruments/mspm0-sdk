...
This example can be used with the spi_controller_multibyte_fifo_dma_interrupts example running on another device.
...
Once the example is started, the SPI Peripheral will wait to receive data.
