...
and USER_TEST pin every 500ms. The device remains in SLEEP mode while waiting
for an interrupt.
...
LED1 and USER_TEST pin will toggle every 500ms, and the device will remain in
