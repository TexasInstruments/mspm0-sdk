...
every 500ms. The device remains in SLEEP mode while waiting for an interrupt.
...
LED1 will toggle every 500ms, and the device will remain in SLEEP while waiting
 for an interrupt.
