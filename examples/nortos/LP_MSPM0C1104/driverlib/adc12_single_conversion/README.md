...
The following example configures ADC0 to trigger single conversion and turn on
LED1 if ADC > 0.5*VDD. Otherwise, LED1 remains off. Note that the ADC resolution
