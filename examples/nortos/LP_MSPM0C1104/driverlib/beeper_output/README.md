...
| PA0 | Beeper | BEEP | J1_10 | <ul><li>PA0 is 5V tolerant open-drain so it requires pull-up<br><ul><li>`J20 1:2` Use 3.3V pull-up<br><li>`J20 2:3` Use 5V pull-up</ul></ul> |
...
The red LED will turn on when the example is running.
USER_TEST_PIN will mimic the behavior of the red LED.
