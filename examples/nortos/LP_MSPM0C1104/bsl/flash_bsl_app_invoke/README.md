...
GPIO port interrupt with an internal pull-up resistor. Uses an input pin to invoke Flash BSL
...
## Example Usage
Compile, load and run the example on device with Flash BSL(refer example: flash_bsl).
Press S2 button to invoke the FLash BSL.
