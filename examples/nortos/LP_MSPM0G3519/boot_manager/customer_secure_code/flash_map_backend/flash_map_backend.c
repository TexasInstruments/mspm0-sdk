...
#if defined(CSC_BANK_SIZE)

#define BOOTLOADER_BASE_ADDRESS (0x00000)
#define BOOT_BOOTLOADER_SIZE (CSC_APPLICATION_IMAGE_BASE_ADDR)
#define BOOT_PRIMARY_BASE_ADDRESS (CSC_APPLICATION_IMAGE_BASE_ADDR)
#define BOOT_PRIMARY_SIZE (CSC_APPLICATION_IMAGE_SIZE)
#define BOOT_SECONDARY_BASE_ADDRESS \
    (CSC_BANK_SIZE + CSC_APPLICATION_IMAGE_BASE_ADDR)
#define BOOT_SECONDARY_SIZE (CSC_APPLICATION_IMAGE_SIZE)

#elif defined(__MSPM0G3519__)

#define BOOTLOADER_BASE_ADDRESS (0x00000)
#define BOOT_BOOTLOADER_SIZE (0x04800)
#define BOOT_PRIMARY_BASE_ADDRESS (0x04800)
#define BOOT_PRIMARY_SIZE (0x02000)
#define BOOT_SECONDARY_BASE_ADDRESS (0x44800)
#define BOOT_SECONDARY_SIZE (0x02000)
...
#define BOOT_PRIMARY_BASE_ADDRESS (0x04800)
#define BOOT_PRIMARY_SIZE (0x02000)
#define BOOT_SECONDARY_BASE_ADDRESS (0x24800)
#define BOOT_SECONDARY_SIZE (0x02000)

#define FLASH_NUM_SECTORS (256)

#elif defined(__MSPM0G3507__)

#define BOOTLOADER_BASE_ADDRESS (0x00000)
#define BOOT_BOOTLOADER_SIZE (0x06000)
#define BOOT_PRIMARY_BASE_ADDRESS (0x06000)
#define BOOT_PRIMARY_SIZE (0x02000)
#define BOOT_SECONDARY_BASE_ADDRESS (0x26000)
#define BOOT_SECONDARY_SIZE (0x02000)
...
#define BOOTLOADER_BASE_ADDRESS (0x00000)
#define BOOT_BOOTLOADER_SIZE (0x0000)
...
static struct flash_area primary_1 = {.fa_id = FLASH_AREA_IMAGE_PRIMARY(0),
    .fa_device_id                            = FLASH_DEVICE_INTERNAL_FLASH,
    .fa_off                                  = CSC_APPLICATION_IMAGE_BASE_ADDR,
    .fa_size                                 = CSC_APPLICATION_IMAGE_SIZE};

static struct flash_area secondary_1 = {.fa_id = FLASH_AREA_IMAGE_SECONDARY(0),
    .fa_device_id                              = FLASH_DEVICE_INTERNAL_FLASH,
    .fa_off  = (CSC_APPLICATION_IMAGE_BASE_ADDR + CSC_BANK_SIZE),
    .fa_size = CSC_APPLICATION_IMAGE_SIZE};
