...
| PA0 | I2C0 | SDA | J5_50 | <ul><li>PA0 is 5V tolerant open-drain so it requires pull-up<br><ul><li>`J16 1:2` Use 3.3V pull-up<br><li>`J16 2:3` Use 5V pull-up</ul><br><li>PA0 can be connected to LED1<br></ul> |
| PA1 | I2C0 | SCL | J5_49 | <ul><li>PA1 is 5V tolerant open-drain so it requires pull-up<br><ul><li>`J17 1:2` Use 3.3V pull-up<br><li>`J17 2:3` Use 5V pull-up</ul></ul> |
