## Example Summary
This example demonstrates how to publish and subscribe events between GPIOA and
GPIOB instances without CPU intervention.

GPIOB instance publishes events via USER_SWITCH_1 to GPIO_EVENT_CHANNEL. GPIOA
is subscribed to GPIO_EVENT_CHANNEL and is configured to toggle
