...
The following examples configures the TRNG peripheral to fill a buffer with
random data.
...
LP-MSPM0G3507, the LED should be off. The application will pause at a SW
breakpoint, where the user can verify that gTRNGBuffer has been filled with
random data. The LED and test pins will be cleared, and the LED will turn on.
