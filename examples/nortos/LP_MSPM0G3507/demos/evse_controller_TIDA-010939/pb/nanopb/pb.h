...
#define PB_STATIC_ASSERT(COND, MSG)    \
    typedef char PB_STATIC_ASSERT_MSG( \
        MSG, __LINE__, __COUNTER__)[(COND) ? 1 : -1];
...
#define PB_GEN_FIELD_INFO_AUTO(                                           \
    structname, atype, htype, ltype, fieldname, tag)                      \
    PB_FIELDINFO_AUTO2(PB_FIELDINFO_WIDTH_AUTO(_PB_ATYPE_##atype,         \
                           _PB_HTYPE_##htype, _PB_LTYPE_##ltype),         \
...
#define PB_FIELDINFO_AUTO3(                                            \
    width, tag, type, data_offset, data_size, size_offset, array_size) \
    PB_FIELDINFO_##width(                                              \
        tag, type, data_offset, data_size, size_offset, array_size)
...
#define PB_GEN_FIELD_INFO_ASSERT_AUTO(                                    \
    structname, atype, htype, ltype, fieldname, tag)                      \
    PB_FIELDINFO_ASSERT_AUTO2(PB_FIELDINFO_WIDTH_AUTO(_PB_ATYPE_##atype,  \
                                  _PB_HTYPE_##htype, _PB_LTYPE_##ltype),  \
        tag, PB_ATYPE_##atype | PB_HTYPE_##htype | PB_LTYPE_MAP_##ltype,  \
        PB_DATA_OFFSET_##atype(_PB_HTYPE_##htype, structname, fieldname), \
        PB_DATA_SIZE_##atype(_PB_HTYPE_##htype, structname, fieldname),   \
