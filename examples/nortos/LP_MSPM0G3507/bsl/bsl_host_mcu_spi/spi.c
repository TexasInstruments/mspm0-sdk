...
void SPI_Initialize(void)
{
    ...
    DL_Interrupt_registerInterrupt((uint32_t)SPI_0_INST_INT_IRQN, SPI_IRQHandler);
...
void SPI_ReadByteArray(uint8_t *data, uint16_t dataLength)
{
    ...
    while (DL_SPI_getRawInterruptStatus(SPI_0_INST, DL_SPI_INTERRUPT_IDLE) != DL_SPI_INTERRUPT_IDLE);
}
