...
| --- | --- | --- | --- | --- |
| UC4 | RX Pin | PA11 | J4_31 | |
| UC4 | TX Pin | PA10 | J4_30 | |
| EVENT | | | | |
| DMA | | | | |
| CRCP | | | | |
| TIMA0 | | | | |
...
| GPIOA | Standard Output | PA22 | LED1 | |
| GPIOB | Standard Output | P26 | LED2  | |
| GPIOB | Standard Input  | P21 | S2 | |
| GPIOB | Standard Output  | PB15 | J2_17 | |
...
MSPM0 LaunchPad, please visit the LP_MSPM0G3218 User's Guide.
...
Note: the BOOSTXL-CANFD-LIN BoosterPack is not directly compatible with the LP_MSPM0G3218 LaunchPad since the pins on the UART connector don't support LIN. For this reason, the BoosterPack shouldn't be stacked on top of the LaunchPad.
...
Each time the S2 button is pressed, LED1 Blue will toggle and the value of the first and last data bytes will be incremented by one.
