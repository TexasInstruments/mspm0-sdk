...
## Example Usage
Compile, load and run the example. Apply voltage to ADC0 pin. Once a DMA done signal is generated the example code will hit the break point instruction and gADCSamples array can be inspected. (applied voltage / 3.3) ~= (avg value in gADCSamples / 4095).
