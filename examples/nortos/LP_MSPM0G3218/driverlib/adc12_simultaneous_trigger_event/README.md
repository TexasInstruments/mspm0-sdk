...
## Example Usage
Compile, load and run the example. Provide a valid voltage to both ADC pins and monitor LED1 (Voltage source for ADC instances is excepted to be between 0v and MCU supply voltage). If voltage provided to ADC0 > voltage provided to ADC1, then LED1 will turn on; otherwise LED1 will turn off.
