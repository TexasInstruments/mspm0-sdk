...
| SYSCTL |  |  |  |  |
| TIMG6 | Capture/Compare Pin 0 | PB2 | J1_4 |  |
| EVENT |  |  |  |  |
...
## Example Usage
Connect to PB6 (GPIO_TIMER_CAPTURE_C0_PIN) to an edge generator source (it can
also be connected to a momentary switch).
Compile, load and run the example.
Generate a rising edge on PB6 (GPIO_TIMER_CAPTURE_C0_PIN). This will cause the
