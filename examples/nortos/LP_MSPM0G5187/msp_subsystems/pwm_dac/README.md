...
The following example configures TIMA0 to output a single edge aligned PWM
...
| --- | --- | --- | --- | --- |
| SYSCTL |  |  |  |  |
| TIMA0 | Capture/Compare Pin 1 | PA1 | J4_31 |  |
| EVENT |  |  |  |  |
...
TIMA0 will output a PWM signal that continuously updates it's duty cycle. 
