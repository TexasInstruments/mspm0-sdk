...
| GPIOB | Standard Input with pull-up | PA7 | S2 | |
...
MSPM0 LaunchPad, please visit the [LP_MSPM0G5187 User's Guide](https://www.ti.com/tool/LP-MSPM0G5187).
...
Note: the BOOSTXL-CANFD-LIN BoosterPack is not directly compatible with the LP_MSPM0G5187 LaunchPad since the pins on the UART connector don't support LIN. For this reason, the BoosterPack shouldn't be stacked on top of the LaunchPad.
