...
Note: the BOOSTXL-CANFD-LIN BoosterPack is not directly compatible with the LP_MSPM0H3217 LaunchPad since the pins on the UART connector don't support LIN. For this reason, the BoosterPack shouldn't be stacked on top of the LaunchPad.
