let M0C1105_C1106_Simple_Entries = [
	// Sources
	"HFCLKEXT",
	"HFXT",
	"LFCLKEXT",
...
let M0C1105_C1106_CLK_OUT_FCC_Entries = [
	// input nets
	"net_sysosc",
	"net_ulpclk",
	"net_lfclk",
...
let M0C1105_C1106_Simple_reasonableLayout = {
...
let M0C1105_C1106_CLK_OUT_FCC_Layout = {
...
let M0C1105_C1106_Simple_BrokenConnections = [
...
let M0C1105_C1106_EXT_BrokenConnections = [
...
const M0C1105_C1106_GATESimple = [
	"net_mclk", "net_ulpclk", "net_lfclk", "net_cpuclk", "net_sysosc",
	"net_mfclk", "net_mfpclk", "net_adcclk", "net_vco"
];

const M0C1105_C1106_GATEEXT = [
	"net_mclk", "net_sysosc", "net_lfclk", "net_hfclk",
	"net_mfpclkGate", "net_ulpclk", "net_exclk"
];

exports = {
    entriesSimple: M0C1105_C1106_Simple_Entries,
    layoutSimple: M0C1105_C1106_Simple_reasonableLayout,
	brokenConnectionsSimple: M0C1105_C1106_Simple_BrokenConnections,
	freqLabelSimple: M0C1105_C1106_GATESimple,
	entriesFull: [],
	layoutFull: {},
	brokenConnectionsFull: [],
	entriesEXT: M0C1105_C1106_CLK_OUT_FCC_Entries,
	freqLabelEXT: M0C1105_C1106_GATEEXT,
	layoutEXT: M0C1105_C1106_CLK_OUT_FCC_Layout,
	brokenConnectionsEXT: M0C1105_C1106_EXT_BrokenConnections
}
