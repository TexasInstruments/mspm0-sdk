...
let M0H321_CLK_OUT_FCC_Entries = [
	// input nets
	"net_sysosc",
	"net_ulpclk",
	"net_lfclk",
...
let M0H321_Simple_reasonableLayout = {
...
let M0H321_Simple_BrokenConnections = [
...
let M0H321_EXT_BrokenConnections = [
...
const M0H321_GATESimple = [
	"net_mclk", "net_ulpclk", "net_lfclk", "net_cpuclk", "net_sysosc",
	"net_mfclk", "net_mfpclk", "net_adcclk", "net_vco"
];

const M0H321_GATEEXT = [
	"net_mclk", "net_sysosc", "net_lfclk", "net_hfclk",
	"net_mfpclkGate", "net_ulpclk", "net_exclk"
];

exports = {
    entriesSimple: M0H321_Simple_Entries,
    layoutSimple: M0H321_Simple_reasonableLayout,
	brokenConnectionsSimple: M0H321_Simple_BrokenConnections,
	freqLabelSimple: M0H321_GATESimple,
	entriesFull: [],
	layoutFull: {},
	brokenConnectionsFull: [],
	entriesEXT: M0H321_CLK_OUT_FCC_Entries,
	freqLabelEXT: M0H321_GATEEXT,
	layoutEXT: M0H321_CLK_OUT_FCC_Layout,
	brokenConnectionsEXT: M0H321_EXT_BrokenConnections
}
