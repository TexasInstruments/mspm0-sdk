let MSPM0L211X_L112X_Simple_Entries = [
	// Sources
	"HFCLKEXT",
	"HFXT",
	"LFCLKEXT",
...
let MSPM0L211X_L112X_CLK_OUT_FCC_Entries = [
	// input nets
	"net_sysosc",
	"net_ulpclk",
	"net_lfclk",
...
let MSPM0L211X_L112X_Simple_reasonableLayout = {
...
let MSPM0L211X_L112X_CLK_OUT_FCC_Layout = {
...
let MSPM0L211X_L112X_Simple_BrokenConnections = [
...
let MSPM0L211X_L112X_EXT_BrokenConnections = [
...
const MSPM0L211X_L112X_GATESimple = [
	"net_mclk", "net_ulpclk", "net_lfclk", "net_cpuclk", "net_sysosc",
	"net_mfclk", "net_mfpclk", "net_adcclk", "net_vco"
];

const MSPM0L211X_L112X_GATEEXT = [
	"net_mclk", "net_sysosc", "net_lfclk", "net_hfclk",
	"net_mfpclkGate", "net_ulpclk", "net_exclk"
];

exports = {
    entriesSimple: MSPM0L211X_L112X_Simple_Entries,
    layoutSimple: MSPM0L211X_L112X_Simple_reasonableLayout,
	brokenConnectionsSimple: MSPM0L211X_L112X_Simple_BrokenConnections,
	freqLabelSimple: MSPM0L211X_L112X_GATESimple,
	entriesFull: [],
	layoutFull: {},
	brokenConnectionsFull: [],
	entriesEXT: MSPM0L211X_L112X_CLK_OUT_FCC_Entries,
	freqLabelEXT: MSPM0L211X_L112X_GATEEXT,
	layoutEXT: MSPM0L211X_L112X_CLK_OUT_FCC_Layout,
	brokenConnectionsEXT: MSPM0L211X_L112X_EXT_BrokenConnections
}
