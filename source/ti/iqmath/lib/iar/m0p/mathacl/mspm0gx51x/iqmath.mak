...
NAME = mathacl/mspm0gx51x/iqmath

OBJ_DIR = ../../../../../obj/iar/m0p/mathacl/mspm0gx51x/iqmath
SRC_DIR = ../../../../../_IQNfunctions

CFLAGS = "-I$(IAR_ARMCOMPILER)/inc/c" "-I$(SDK_INSTALL_DIR)/source/third_party/CMSIS/Core/Include" "-I$(SDK_INSTALL_DIR)/source" --cpu Cortex-M0+ -D__IQMATH_USE_MATHACL__ -D__MSPM0G3519__ --aeabi --guard_calls --endian=little --thumb --silent -e --use_unix_directory_separators --diag_suppress=Pa050,Go005 --debug -Ohs
AFLAGS = 
